...
public class UpdateForm implements Serializable, PasswordCarrier {
    ...
    public void withConfirm(String confirm) { this.confirm = confirm; }
    ...
    public void withDob(LocalDate dob) { this.dob = dob; }
    public void setDob(LocalDate dob) { this.dob = dob; }

    public void withFiscalCode(String fiscalCode) { this.fiscalCode = fiscalCode.toUpperCase(); }
    public void setFiscalCode(String fiscalCode) { this.fiscalCode = fiscalCode.toUpperCase(); }

    public void withStreet(String street) { this.street = street; }
    ...
    public void withPhone(String phone) { this.phone = (phone == null || phone.isEmpty()) ? "N/A" : phone; }
    public void setPhone(String phone) { this.phone = (phone == null || phone.isEmpty()) ? "N/A" : phone; }

    public void withRole(RoleType role) { this.role = role; }
